...
(defvar catalogo
  (list
   (make-item :nome "Lamina da destruicao " :tipo "Arma" :preco 200 :forca-magica 150)
   (make-item :nome "Adaga das tormentas " :tipo "Arma" :preco 120 :forca-magica 120)
   (make-item :nome "Pocao de cura - fraca" :tipo "Pocao" :preco 80 :forca-magica  40)
   (make-item :nome "Orbe Ancestral" :tipo "Artefato" :preco 500 :forca-magica 200)))
