...
<center><img src= 'fotos/Exercicio_3.png' ></center>  
...
```
irmaos_germanos(A, B) :-progenitor(Pai, A),progenitor(Pai, B),progenitor(Mae, A),progenitor(Mae, B),A \= B,Pai \= Mae.
```
...
<center><img src= 'fotos/resp_1.png' ></center>  
